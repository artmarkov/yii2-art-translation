...
/**
 * SourceController implements the CRUD actions for artsoft\translation\models\MessageSource model.
 */
class SourceController extends BaseController
{
    public $modelClass = 'artsoft\translation\models\MessageSource';
