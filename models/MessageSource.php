...
namespace artsoft\translation\models;
 ...
 */
class MessageSource extends \artsoft\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('art', 'ID'),
            'category' => Yii::t('art/translation', 'Category'),
            'message' => Yii::t('art/translation', 'Source Message'),
            'immutable' => Yii::t('art/translation', 'Immutable'),
        ];
    }
